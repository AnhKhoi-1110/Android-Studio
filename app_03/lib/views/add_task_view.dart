...
class _AddTaskViewState extends State<AddTaskView> {
  ...
  List<String> attachments = []; // Danh sách lưu đường dẫn ảnh
  ...
  void _submit() async {
    if (_formKey.currentState?.validate() ?? false) {
      await _taskController.createTask(
        ...
        priority: _priority,
        dueDate: _dueDate,
        createdBy: _loggedUser !.id, // Gán ID người tạo
        assignedTo: _loggedUser !.isAdmin ? _assignedTo : _loggedUser !.id, // Nếu là admin, cho phép gán cho người khác
      );
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              if (_loggedUser !.isAdmin) // Chỉ hiển thị dropdown nếu là admin
                SizedBox(height: 16),
              if (_loggedUser !.isAdmin) // Chỉ hiển thị dropdown nếu là admin
                DropdownButtonFormField<String>(
                  value: _assignedTo,
