...
import 'package:share/share.dart'; // Thêm import cho share
...
class _TaskListViewState extends State<TaskListView> {
  ...
  void _loadUsers() async {
    users = await _userController.getUsers();
  }

  void _getLoggedUser () async {
    _loggedUser  = await _userController.getLoggedUser ();
  }
      ...
      builder: (context) {
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              onPressed: () async {
                await _userController.removeUser (_loggedUser !.id);
                Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (_) => LoginView()));
              },
              child: Text('Xóa'),
            ),
  ...
  void _shareTask(Task task) {
    final String message = 'Task: ${task.title}\nDescription: ${task.description}\nDue Date: ${task.dueDate}';
    Share.share(message);
  }
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            icon: const Icon(Icons.delete), // Nút xóa tài khoản
      ...
      floatingActionButton: MouseRegion(
        ...
        child: AnimatedContainer(
          ...
          child: FloatingActionButton(
            ...
            backgroundColor: _isButtonHovered ? Colors.blueAccent : Colors.blue,
          ),
        ),
      ),
    );
        ...
        return Card(
          ...
          child: ListTile(
            ...
            trailing: Row(
              ...
              children: [
                IconButton(
                  icon: Icon(Icons.delete), // Nút xóa
                  onPressed: () async {
